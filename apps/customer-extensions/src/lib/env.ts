...
export const env = createEnv({
  ...
  server: {
    ...
    MANIFEST_APP_ID: z.string().optional().default("saleor.app.customer.extensions"),
    OTEL_ACCESS_TOKEN: z.string().optional(),
    OTEL_ENABLED: booleanSchema.optional().default("false"),
    OTEL_SERVICE_NAME: z.string().optional().default("saleor-app-customer-extensions"),
    PORT: z.coerce.number().optional().default(3010),
    ...
    INIT_DYNAMODB_ON_STARTUP: booleanSchema.optional().default("false"),
    APPSTORE_URL: z.string().optional(),
    APP_NAME: z.string().optional().default("Customer Extensions"),
    REQUIRE_ORDER_UNLOCK_FOR_REVIEWS: booleanSchema.optional().default("false"),
  },
  shared: {
  ...
  runtimeEnv: {
    ...
    INIT_DYNAMODB_ON_STARTUP: process.env.INIT_DYNAMODB_ON_STARTUP,
    APPSTORE_URL: process.env.APPSTORE_URL,
    APP_NAME: process.env.APP_NAME,
    REQUIRE_ORDER_UNLOCK_FOR_REVIEWS: process.env.REQUIRE_ORDER_UNLOCK_FOR_REVIEWS,
  },
