...
/**
 * This table is used to store all relevant data for the Customer Extensions application:
 * - Wishlists and wishlist items
 * - Product reviews
 * - APL (Auth Persistence Layer) data
 */
export class DynamoMainTable extends Table<PartitionKey, SortKey> {
   ...
   * Use Case: Configuration, app metadata
   */
   ...
   * Use case: APL, user wishlists, product reviews
   */
